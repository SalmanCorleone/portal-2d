...
public class Portal2 {
    private BluePortal2 blue;
    private OrangePortal2 orange;
//    Person p1= new Person();
    ...
    public Portal2()
    {
    	blue=new BluePortal2();
    	orange= new OrangePortal2();
    }
    ...
    public int goForGrav(MPlayer2 b, double ya)
    {
