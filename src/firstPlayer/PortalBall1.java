...
public class PortalBall1 {
	...
	double xa;
	double ya;
	private MPlayer1 guy;
	MLevel1 m;
	private int PaintFlag=0;
	private int ColorFlag;


	public PortalBall1(MPlayer1 person, MLevel1 mp) {
		guy= person;
		this.m=mp;
		try {
...
//			System.out.println(x+" "+y);
			...
			{ 
				...
				m.port.set(x+20, y-15, ColorFlag,22);
			}
			...
			{ 
				...
				System.out.println("colorFlag"+ ColorFlag);
				m.port.set(x-5, y-15, ColorFlag,21);
			}
