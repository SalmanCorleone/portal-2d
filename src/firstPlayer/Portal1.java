...
public class Portal1 {
    private BluePortal1 blue;
    private OrangePortal1 orange;
//    Person p1= new Person();
    ...
    public Portal1()
    {
    	blue=new BluePortal1();
    	orange= new OrangePortal1();
    }
    ...
    public int goForGrav(MPlayer1 b, double ya)
    {
